...
// 🖼️ Import Assets
import photo from '../../public/photos.jpeg'
...
export default function Home() {
  ...
  const quickLinks = [
    ...
    { img: linkedinLogo, title: 'LinkedIn', link: 'https://www.linkedin.com/in/tushar-b-696777238/' },
    { img: gmailLogo, title: 'Email', link: 'tusharbharambe2005@gmail.com' },
    ...
    >
      ...
      >
        ...
        >
          ...
          >
          Aritificial Intellegence Engineer | FullStack Developer | Tech Explorer
          </p>
          ...
          >
            {[ 
              { label: '📍 Location', value: 'Jalgaon,Maharashtra,India' },
              { label: '💼 Expertise', value: 'AI/ML,Problem solving,backend dev.' },
              { label: '📧 Contact', value: 'Tusharbharambe2005@gmail.com' },
            ].map((info, i) => (
              <motion.div
                key={i}
