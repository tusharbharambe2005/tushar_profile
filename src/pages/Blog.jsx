...
export default function Blog() {
  const defaultPosts = [
    ...
    },
    {
      ...
      text: "As someone who codes daily and constantly explores new technologies, I’ve learned that growth comes from consistent practice. Every project — small or big — teaches me something valuable about design, logic, or performance.",
    },
    {
      id: 4,
      title: "The Beauty of Clean & Simple Code",
      text: "For me, great code is simple, readable, and purposeful. Clean architecture turns a project into something long-lasting, and each function feels like it fits exactly where it should — no clutter, no chaos.",
    },
  ];
